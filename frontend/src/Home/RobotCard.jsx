...
export function RobotCard({ robot, index, isInView }) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
    >
      <div className="relative bg-white/90 dark:bg-black/80 rounded-lg overflow-hidden">
        <div className="aspect-video relative">
          <ReactPlayer
            ...
            width="100%"
            height="100%"
            className="absolute top-0 left-0 transform group-hover:scale-105 transition-transform duration-700"
          />
